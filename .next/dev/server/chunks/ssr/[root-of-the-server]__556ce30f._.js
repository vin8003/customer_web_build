...
function OrderDetails() {
    ...
    const loadOrderDetails = async ()=>{
        setIsLoading(true);
        try {
            const data = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["apiService"].getOrderDetail(Number(orderId));
            setOrder(data);
        } catch (error) {
            console.error(error);
        } finally{
...
//# sourceMappingURL=%5Broot-of-the-server%5D__556ce30f._.js.map